...
public class FinalResultFour extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_final_result_four);
	...
	public void onClick(View v) {
		...
		{	Intent w = new Intent(FinalResultFour.this, LevelFive.class);
		    startActivity(w);
		}
		else if(b.getText().toString()=="Try Again")
		{  Intent l = new Intent(FinalResultFour.this, LevelFour.class);
		   startActivity(l); 
		}
	SharedPreferences myprefs= this.getSharedPreferences("user", MODE_WORLD_READABLE);
	 myprefs.edit().putString("level_id_4", b.getText().toString()).commit(); }
